<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('{{ Auth::user()->profile_photo_url }}')">
            </div>
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="/documentation/bootstrap/overview/soft-ui-dashboard/index.html" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">{{ \Carbon\Carbon::parse(now()->toDateTimeString())->format('d/m/Y') }}</a>
                </div>
            </div>
        </div>
    </div>
